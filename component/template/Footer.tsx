import { IconBrandFacebook, IconBrandInstagram, IconBrandTelegram, IconBrandTwitter, IconBrandYoutube, IconLocation, IconMail, IconPhone } from "@tabler/icons-react";
          ...
          <div className="text-white">
            <li className="flex flex-row justify-between max-sm:flex-col">
              ...
              <div className="flex flex-row items-center max-sm:mt-3 ">
                <Link href="/" className="p-1 mr-2 border border-gray-600 border-solid rounded-full ">
            ...
            <div className="grid lg:grid-cols-12 md:grid-cols-2 sm:grid-cols-1 gap-7">
              ...
              <ul className="lg:col-span-2 md:col-span-1 sm:col-span-1 lg:mt-5 lg:mb-5 ">
                ...
                <li className="pt-2 "> 
                   <Link className="text-sm font-semibold text-gray-600 hover:text-white " href="/about" > About Us</Link>
                </li>
                <li className=""> 
                   <Link className="text-sm font-semibold text-gray-600 hover:text-white " href="/advantage" > Services</Link>
                </li> 
                <li className=""> 
                   <Link className="text-sm font-semibold text-gray-600 hover:text-white" href="/privacy-policy" > Privacy Policy</Link>
                </li>
                <li className=""> 
                   <Link className="text-sm font-semibold text-gray-600 hover:text-white" href="/terms-of-use" >Terms of Use</Link>
                </li>
                <li className=""> 
                   <Link className="text-sm font-semibold text-gray-600 hover:text-white" href="/faq" >F&amp;Qs</Link>
                </li>
              </ul>
              <ul className="lg:col-span-2 md:col-span-1 sm:col-span-1 lg:mt-5 lg:mb-5 ">
                <h6 className="w-[100px]  border-b border-b-[#8900a1]  mb-2  py-2"> Contact Us</h6>
                <li className="flex flex-row pt-2 hover:text-white "> 
                  <Link className="flex flex-row items-center hover:text-white " href="tel:20 999 999 9999"> <IconPhone className="w-5 mr-2 text-sm text-gray-600" /><span className="text-sm font-semibold text-gray-600 hover:text-white ">+20 999 999 9999</span></Link>
                </li>
                <li className="flex flex-row pt-2 hover:text-white "> 
                <Link className="flex flex-row items-center hover:text-white "  href="mailto:info@stayexpo.com"> <IconMail className="w-5 mr-2 text-sm text-gray-600 " /><span className="text-sm font-semibold text-gray-600 hover:text-white "> info@stayexpo.com</span></Link> 
                </li>
                <li className="flex flex-row pt-2 hover:text-white "> 
                  <Link className="flex flex-row items-center hover:text-white "  href="http://maps.google.com/?q=1200"> <IconLocation className="w-5 mr-2 text-sm text-gray-600 " /><span className="text-sm font-semibold text-gray-600 hover:text-white ">Cairo,Egypt</span></Link>
                </li>
                <li className="flex flex-row pt-2 hover:text-white "> 
                  <Link className="flex flex-row items-center hover:text-white " href="tel:20 999 999 9999"> <IconPhone className="w-5 mr-2 text-sm text-gray-600" /><span className="text-sm font-semibold text-gray-600 hover:text-white ">+20 999 999 9999</span></Link>
                </li>
              ...
              <ul className="lg:col-span-8 md:col-span-2 sm:col-span-1 lg:mt-5 lg:mb-5 ">
                ...
                <li className="pt-2 "> 
                     ...
                     <fieldset>
                       ...
                       <p className="font-semibold text-gray-600 test-xsm ">StayExpo is an independent and privately owned tour operator.
