...
export default function SideBar({ children, onOpen, onClose }: any) {

  return (
    <div>
    <div className={`${(onOpen && '!block') || ''} fixed inset-0 bg-[black]/60 z-[51] px-4 hidden transition-[display]`} onClick={() => onClose(false)}></div>
